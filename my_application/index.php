...
<div id="successMessage" class="alert alert-success" style="display:none;">
	...
	<div class="container">
		...
		$user_id = $USER->GetId();
		$stmt = $pdo->prepare("SELECT * FROM user_applications a WHERE user_id =:user_id AND is_editable = 1" AND not exists (SELECT 1 FROM user_applications b WHERE a.id = b.id AND user_id = :user_id));
