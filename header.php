...
<div>
	...
	<div id="navigation" class="navig">
		<div id="menu-container">
			<a href="/local/lab/" class="ga-nav">Главная</a>
			<a href="/local/lab/my_application" class="ga-nav">Мои заявки</a>
			<a href="/local/lab/tasks" class="ga-nav">В работе</a>
			<a href="/local/lab/" class="ga-nav">Отчёты</a>
			<a href="/local/lab/" class="ga-nav">Архив</a>
			<a href="/local/lab/contacts/" class="ga-nav">Контакты</a>
		</div>
	</div>
</div>
</header>
